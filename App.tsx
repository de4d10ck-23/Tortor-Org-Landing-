...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-20 selection:bg-indigo-500 selection:text-white bg-[#0f172a]">
      ...
      <nav className="sticky top-0 z-[60] glass border-b border-white/5 px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            <a
              href="#"
              className="text-2xl font-black tracking-tighter text-white hover:text-indigo-400 transition-colors flex items-center gap-2"
            >
              tortor.org
            </a>
          </div>
      ...
      <header className="relative pt-20 pb-24 px-6 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-6xl mx-auto text-center space-y-6">
          ...
          <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-white">
            Building the <span className="gradient-text">Future</span>, Guided
            by the <span className="gradient-text">Tortor</span> Legacy. <br />
          </h1>
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            A unified endeavor dedicated to the pursuit of high-performance
            innovation and the advancement of the future. We bridge the gap
            between today’s potential and tomorrow’s reality through shared
            excellence.
          </p>
        </div>
      </header>
      ...
      <section
        id="projects"
        className="py-24 px-6 border-b border-white/5 scroll-mt-20"
      >
        <div className="max-w-6xl mx-auto mb-16">
          ...
          <p className="text-slate-400 max-w-xl">
            A gallery of technical excellence across multiple domains.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto mb-12 glass rounded-3xl p-4 flex flex-col md:flex-row gap-6 items-center justify-between">
          ...
          <div className="relative w-full md:w-80 group">
            ...
            />
            <svg
              className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-slate-500 group-hover:text-slate-300 transition-colors"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      >
        <div className="max-w-6xl mx-auto mb-16">
          ...
          <p className="text-slate-400 max-w-xl">
            The creative minds behind our most ambitious digital explorations.
          </p>
        </div>
      ...
      <section
        id="about"
        className="py-32 px-6 border-b border-white/5 scroll-mt-20"
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl font-bold text-white">
              About <span className="gradient-text">tortor.org</span>
            </h2>
            <p className="text-slate-400 text-lg leading-relaxed">
              Our approach combines the rigor of technical research with a
              commitment to enduring impact. By merging high-performance
              engineering with visionary thinking, we don't just adapt to the
              future—we architect it.
            </p>
          ...
          <div className="glass rounded-3xl p-2 h-96 overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent flex items-end p-8">
              <span className="text-white font-medium italic">
                "Designing the invisible layer of the digital world."
              </span>
            </div>
          </div>
        </div>
      ...
      <section id="contact" className="py-32 px-6 scroll-mt-20">
        <div className="max-w-4xl mx-auto glass p-8 md:p-12 rounded-[3rem] space-y-12 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Email */}
            <a
              href="mailto:johnlloydttortor@gmail.com"
              className="group glass p-8 rounded-3xl hover:bg-white/5 transition-all text-center flex flex-col items-center"
            >
              ...
              <h4 className="text-indigo-400 uppercase tracking-widest text-xs font-bold mb-2">
                Email
              </h4>
              <p className="text-white font-semibold break-all">
                johnlloydttortor@gmail.com
              </p>
            </a>

            {/* Phone */}
            <a
              href="tel:+639539870591"
              className="group glass p-8 rounded-3xl hover:bg-white/5 transition-all text-center flex flex-col items-center"
            >
              ...
              <h4 className="text-purple-400 uppercase tracking-widest text-xs font-bold mb-2">
                Phone
              </h4>
            ...
            <div className="group glass p-8 rounded-3xl hover:bg-white/5 transition-all text-center flex flex-col items-center">
              ...
              <h4 className="text-blue-400 uppercase tracking-widest text-xs font-bold mb-2">
                Location
              </h4>
              <p className="text-white font-semibold">
                Bontoc, Southern Leyte, PH
              </p>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-white/5 flex flex-col items-center gap-6">
            <h4 className="text-slate-500 uppercase tracking-[0.2em] text-xs font-bold">
              Connect with me
            </h4>
